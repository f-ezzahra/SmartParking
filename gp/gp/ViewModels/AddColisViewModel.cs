...
namespace gp.ViewModels
{
    ...
    public class AddColisViewModel : BaseViewModel
    {
        ...
        public AddColisViewModel(string livraisonId)
        {

            _livraisonId = livraisonId;
            context = Realm.GetInstance();

            var livraison = context.All<Livraison>().Where(t => t.LivraisonId == livraisonId).FirstOrDefault();
        ...
        void SaveColis()
        {
            ...
            var livraison = context.All<Livraison>().Where(t => t.LivraisonId == _livraisonId).FirstOrDefault();

            context.Write(() =>
            {

                context.Add<Colis>(new Colis()
                {
