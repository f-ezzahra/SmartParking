...
{
    class LivraisonDetailsViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<Colis> coliss;
        public ObservableCollection<Colis> Coliss
        {
            get { return coliss; }
            set { coliss = value; }
        }
        ...
        public LivraisonDetailsViewModel(string livraisonId)
        {
            ...
            Coliss = new ObservableCollection<Colis>(context.All<Colis>().Where(p => p.Livraison == livraison));
